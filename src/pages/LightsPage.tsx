...
const expertise = [
  ...
  { icon: Settings, title: "Modular Systems", desc: "Our track and belt systems are fully modular — combine nodes, buckles, floodlights, and glass ball linkers to create custom configurations." },
  { icon: Palette, title: "Design Forward", desc: "Every product is selected for its aesthetic impact, bringing world-class design sensibility to Indian interiors." },
            ...
            <div>
              ...
              <div className="space-y-3 text-sm font-body text-secondary-foreground">
                <div className="flex items-center gap-3">
                  ...
                  <span>Available in 10m and 20m lengths</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-1.5 h-1.5 bg-primary" />
                  <span>5 color options · DC 24V · 9A Max</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-1.5 h-1.5 bg-primary" />
                  <span>Polyester belt material for durability</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-1.5 h-1.5 bg-primary" />
                  <span>Surface mounted & recessed installation</span>
                </div>
              </div>
            </div>
            <div className="aspect-square overflow-hidden">
